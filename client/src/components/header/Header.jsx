...
const Header = () => {
    ...
    const linkClass = ({ isActive }) =>
        isActive
            ? 'block py-2 pr-4 pl-3 text-blue-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:p-0 font-medium'
            : 'block py-2 pr-4 pl-3 text-gray-700 border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-blue-700 lg:p-0 font-medium';
                        ...
                        <div 
                            ...
                            {isAuthenticated && (
                                <ul 
                                    ...
                                    <li>
                                        <span className='block py-2 px-3 text-blue-700 rounded lg:border-0 lg:p-0'><span className='pr-4'>|</span>Welcome, {username}</span>
                                    </li>
                                </ul>
                            )}
